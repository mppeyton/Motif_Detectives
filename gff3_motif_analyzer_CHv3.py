...
#		line2 = [Chromosome, feature, start, end, new_description]
		line2 = 'Chr' + Chromosome + ' ' + start + ' : ' + end + '\t' + feature + '\t' + new_description
#		print(line2)
...
# added motif to output
#					gene_feature.setdefault('Chromosome.' + Chromosome, []).extend([line2])
					gene_feature.setdefault('Chromosome.' + Chromosome, []).extend(['motif ' + motif + ' found in ' + line2])
#print(gene_feature)
